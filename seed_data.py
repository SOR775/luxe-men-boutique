...
def seed():
    ...
    if not User.objects.filter(email='admin@luxemen.com').exists():
        User.objects.create_superuser(
            email='admin@luxemen.com', username='admin', password='admin123',
            first_name='Admin', last_name='User'
        )
        print("  Superuser created: admin@luxemen.com / admin123")
    ...
    for first, last, email in [
        ...
        if created:
            ...
            customer.save()
            print(f"  Customer created: {email} / customer123")
